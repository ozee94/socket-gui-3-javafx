...
public class Service5333Controller implements Initializable {
	
	@FXML private TextField hostname, port;
	@FXML private TextField transmission_number, transmission_code, receive_code, 
		designated_law_code, occurrence_location, longitude, latitude, name, phone, birth,
		gender, address, protector_name, protector_phone, occurrence_date, image, 
		personal_information, note, sender_id;
	...
	public void initialize(URL location, ResourceBundle resources) {
		progress_code.getItems().addAll("10-상황발생");
	...
	public void onSend() {
		...
		String body = "WP" + transmission_number.getText() + CService.SEPERATOR + "기어S2" + CService.SEPERATOR + longitude.getText() + CService.SEPERATOR
				+ latitude.getText() + CService.SEPERATOR + occurrence_location.getText() + CService.SEPERATOR
				+ designated_law_code.getText() + CService.SEPERATOR + "-" + CService.SEPERATOR + name.getText() + CService.SEPERATOR
				+ phone.getText() + CService.SEPERATOR + birth.getText() + CService.SEPERATOR + gender.getText() + CService.SEPERATOR
				+ address.getText() + CService.SEPERATOR + protector_name.getText() + CService.SEPERATOR + protector_phone.getText() + CService.SEPERATOR
				+ occurrence_date.getText() + CService.SEPERATOR + image.getText() + CService.SEPERATOR + personal_information.getText() + CService.SEPERATOR 
				+ note.getText() + CService.SEPERATOR + sender_id.getText() + CService.SEPERATOR + ";";
