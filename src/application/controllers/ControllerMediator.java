...
public class ControllerMediator {
	...
	public void setPanelViewController(PanelViewController panelViewController) {
		if(this.panelViewController == null) this.panelViewController = panelViewController;
	}
	...
	public void setTreeViewController(TreeViewController treeViewController) {
		if(this.treeViewController == null) this.treeViewController = treeViewController;
	}

	public static ControllerMediator getInstance () {
		if(instance == null) {
			System.out.println("ControllerMediator 초기화");
